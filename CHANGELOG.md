...
- ✨ decision on using Cocogitto for checking commit messages (#276)

## 0.11.0 (2026-06-08)

### Feat

- ✨ decision post on why to use Cocogitto (#277)

## 0.10.0 (2026-06-08)

### Feat

- ✨ decision post on why to use git-cliff for changelogs (#273)

## 0.9.0 (2026-06-02)

### Feat

- ✨ refine instructions in decision-making template (#283)

## 0.8.1 (2026-03-03)

### Fix

- :bug: correct broken/redirected links (#256)

## 0.8.0 (2026-02-20)

### Feat

- :sparkles: post on why we will use rumdl (#253)

## 0.7.0 (2026-02-04)

### Feat

- :sparkles: add Why Git LFS post (#244)

## 0.6.0 (2026-02-04)

### Feat

- :sparkles: post on using Diataxis for docs (#241)
