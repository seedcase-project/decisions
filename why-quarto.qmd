...
users and contributors), the most common way being to put these content (like
documentation) on a website. In order to minimize the work the team
needs to do, we would like to use the files we maintain in GitHub as the
basis for a public website. The question then becomes:
