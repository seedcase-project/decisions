...
Principles](https://design.seedcase-project.org/). A clear and
...
branches that will be merged into `main` less frequently.
...
release version will be tagged.
...
is a simpler branching strategy than Git flow, revolving around the
...
- Might be more susceptible to bugs in production (compared to Git flow)
  because of the lack of dedicated development branches
