...
Since we follow the [GitHub flow](/why-github-flow/index.qmd), changes
are made on topic branches and reviewed before merging into the main
branch. Having a clear commit message convention can ease the review
process, as the context and purpose of changes will be clearer for
reviewers.
...
- Include a short descriptive title, potentially followed by a body with
  more details.
...
The conventional commits convention is also supported by a
[VS Code extension](https://marketplace.visualstudio.com/items?itemName=vivaxy.vscode-conventional-commits)
...
- Provides a clear structure for commit messages.
- Has an easy-to-use VS Code extension.
- The use of emojis can make commit messages more visually appealing and
  easier to scan to identify the purpose or intention.
...
- For those not familiar with emojis or who are less visually oriented,
  it might be harder to understand the meaning of the commit.
...
convention. See the
[Why atomic commits and PRs](/why-atomic-commits-and-prs/index.qmd)
decision post for a discussion of such conventions.
