...
communities, including the open science communities. Its structured
format aligns well with the organized and systematic approach favoured
in open-science projects. Additionally, its is compatible with automated
release processes which makes it appealing for managing versioning in
software projects.
...
-   Widespread adoption in various software development and open science
    communities.
:::
...
**Gitmojis** convention). The Conventional Commits convention is widely
