...
- Code is run on a Java Virtual Machine, making Java programs,
  generally, platform independent (provided the host has a Java Runtime
...
- Comes with inline documentation generation system out of the box
  (Javadoc).
- Large ecosystem of mature libraries and frameworks for web development
...
- Code is executed by a Python interpreter, making Python programs
  platform independent (provided the host has an interpreter installed).
- Concise, easy-to-read, beginner-friendly syntax.
- Easy to iterate and prototype rapidly.
- Large ecosystem of mature libraries and frameworks for web development
  (e.g. [Django](https://www.djangoproject.com),
  [Flask](https://flask.palletsprojects.com/en/stable/)), database
...
- Worse runtime performance than Java or C++, partly because the
  ...
  the layout of the source coded sequentially during program execution.
...
- While there is a web application framework for R
  ...
  interactive data visualisation, and offers more limited features than
  the frameworks for the other languages considered.
