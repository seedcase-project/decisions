...
surprisingly wasn't listed in the resources above (likely for the
opposite reasons we didn't consider the tools they list).

### Frictionless Data

[Frictionless Data](https://frictionlessdata.io/) and it's companion
...
and the organization who owns and is responsible for development of this
standard, which is the Open Knowledge Foundation and is a non-profit
organization, does work in other areas that also align with our values
and principles.
