...
- Closely aligned with Python's standard typing specifications (PEP 484
  and related PEPs).
...
- As Pylance bundles Pyright and type stubs locally, but in CI pipelines
  the Pyright CLI relies on the CI environment, their diagnostics may
...
- Pyrefly aims to provide better IDE integration, richer type inference,
  and more responsive developer feedback compared to Pyre.
...
- We should keep an eye on `mypy`'s performance, just in case it begins
  to impact developer experience negatively.
...
- [Python Advanced: Mypy vs Pyright](https://python.plainenglish.io/python-advanced-mypy-vs-pyright-a-detailed-comparison-with-examples-40e2c2d94e3f)
- [Introducing Pyrefly](https://engineering.fb.com/2025/05/15/developer-tools/introducing-pyrefly-a-new-type-checker-and-ide-experience-for-python/)
- [Google Ends Support for Pytype](https://medium.com/techtofreedom/google-ends-support-for-pytype-this-is-how-python-developers-can-adapt-a703d964028a)
- [Static Type Checking in Python](https://engineering.blackrock.com/static-type-checking-in-python-where-did-the-ducks-go-d17881d3205e)
