...
2. Only use alphanumeric characters (avoid punctuation, spaces,
...
the [Why GitHub projects](why-github-projects.qmd) post), which
...
Some teams include the initials of the author in the branch name to keep track of each developer's work. Let's outline the benefits and drawbacks of this practice:
...
This convention is easy to implement, using the [Conventional Branch](https://marketplace.visualstudio.com/items?itemName=pshaddel.conventional-branch) extension for VS Code. This extension lets us define the wanted naming structure and can easily be used to create new branches with the correct naming convention (using the command palette in VS Code).
