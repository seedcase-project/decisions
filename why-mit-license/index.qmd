...
description: |
  ...
  ease collaboration and re-use, and sharing intellectual ideas with others. This post contains our
...
-   The only major drawback is the same thing as it's strength: It is so
    ...
    they see fit, including in proprietary software. This can be seen as
...
-   The patent section is a bit difficult to understand as a developer,
    so presumably is difficult for users.
...
specific in it's language. In simple terms, it is a worse version of the
MIT License. So we don't covered it here.
