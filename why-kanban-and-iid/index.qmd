...
An analogy might be building a house one room at a time (incremental),
but within each room, starting with making a rough sketch, then adding
pieces to it slowly, all while regularly getting feedback and refining
the design based on the feedback (iterative).
