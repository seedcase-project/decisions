---
title: "Why a mix of Kanban and iterative and incremental development"
description: "Developing software can be done many ways, especially when working in a team. Here we describe why we chose to mix aspects of Kanban with an iterative and incremental development workflow."
date: "2026-01-12"
categories:
- workflow
- develop
...
*What planning and management process or workflow should we use to help
manage and coordinate the developing software and other types of
...
development. Because of this, it makes it very difficult to easily compare
...
Because of this, it is easier to compare it to the other options.
...
An analogy might be making a painting or drawing. Start with a rough
sketch, and then slowly add in more detail as you go along.
...
An analogy might be building a house one room at a time. Each room is a
...
-   A strong initial planning and design phase helps to ensure a strong
    ...
    ensure as much of the user requirements are incorporated as
    possible.
-   Much easier to create and manage a roadmap or plan, as the overall
    project is broken down into smaller, more manageable pieces.
...
-   Like with iterative development, if additional requirements or needs
    come up during the process, it requires changing the plan and where
    or how increments are developed.
-   Because there is less focus on getting user feedback regularly and
    often, there may be a risk of a misalignment between the final product and the user needs and
    expectations.
:::
:::::
...
This is the combination of both an [iterative and an incremental
development](https://en.wikipedia.org/wiki/Iterative_and_incremental_development)
approach. It involves breaking down the project into smaller increments,
and then within each increment, following an iterative cycle of
designing, prototyping, testing, analyzing, and refining.
...
-   Doesn't have as many of the drawbacks of either approach alone, as
    the weaknesses of one approach are often mitigated by the strengths
    of the other.
:::
...
-   Because it combines two different approaches, it can be more complex
    and difficult to manage effectively, so it needs a strong and
...
each sprint), and other rituals and processes to help teams work
...
-   Lots of training material is available, as well as experienced
    practitioners.
-   Has a lot of rituals and processes, which can help those who are new
    to software development or team-based work to have a clear structure
    to follow.
:::
...
-   Its rituals and processes can end up adding a lot more overhead and
    inflexibility, because it is a "recipe to follow", which makes
    non-technical management follow it more strictly than is necessary.
...
-   Can lead to a focus on completing tasks within the sprint, rather
    than on delivering value to the user.
...
-   Without proper discipline and management, tasks can start piling up.
    It requires a cultural mindset.
...
and retrospectives from Scrum are all also useful.

### Consequences

-   There will be some management and planning overhead in order to
    curate the workflow. But we believe it is worth it from a
    stress and cognitive load perspective. That's because it helps us to
    have a structure and a general goal or roadmap that we are working
    towards.
